...
// "https://marketsupply.plentymarkets-cloud01.com/export/68/tJtzXsreUg3ogW0uBMxDU55EMNvo3227";
const storageDir = "downloads";
const getReportViaFeedUrl = async (storageDir, feedUrl) => {
...
getReportViaFeedUrl(storageDir, testUrl);
